@echo off
REM ============================================================
REM Day 07 -- Break-Even Analysis Tool, local launcher
REM
REM Day-N port convention:  port = 1000 + N
REM   Day 07 -> 1007
REM
REM Double-click this file to start the model at
REM http://127.0.0.1:1007/ in your default browser.
REM
REM   start.bat            -- default port 1007
REM   start.bat 1106       -- custom port (override)
REM
...
if not exist "server.py" (
    ...
    echo Make sure start.bat is sitting next to server.py inside day-07-earnings-summariser\.
    echo.
    pause
    exit /b 1
)
...
REM --- Resolve port (arg 1 or default 1007 for Day 07) ---------------------
set "PORT=%~1"
if "%PORT%"=="" set "PORT=1007"

REM --- Detect port-in-use and pick an alternate -----------------------------
REM Fallback ports for Day 07 are 1106, 1206, 1306 (keeps day-distinct).
...
if errorlevel 1 (
    echo NOTICE: port %PORT% is already in use. Trying 1106, 1206, 1306 in turn...
    for %%P in (1106 1206 1306) do (
